...
| --- | --- | --- |
| Whitepaper | `docs/en/reference/*` | Explain the investment case and reading order |
| Architecture | `docs/en/architecture/*` | Explain structure, boundaries, and information flow |
| Playbook | `docs/en/guides/*` | Translate the shell into phased action |
...
3. Use the [Adoption Path](../guides/adoption-path) and [Role Paths](../guides/role-paths) to decide rollout steps.
